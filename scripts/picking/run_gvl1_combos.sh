#!/bin/bash
# GVL-1 (Haute-Sorne) radial-vs-isotropic waveset comparison, on the prod3 K2 BLANKET maps.
#
...
ISO_TAG=test_2026-08-07_gvl1_iso_combos_z8
RAD_TAG=test_2026-08-07_gvl1_radial_combos_z8
