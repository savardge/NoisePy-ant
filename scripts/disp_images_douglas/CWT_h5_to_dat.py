...
stack_dir = "/srv/beegfs/scratch/shares/cdff/MIGRATE/Tuscany_July2023/noisepyH5/stack-1bit"
...
for fname in filelist:
    ...
    try:
        ...
        amp, phase, per, vel, coi = get_disp_image_taper(ccf,  # numpy array of the symmetric CCF
