...
dfmaster = pd.DataFrame({'period':[], 'dist_over_lambda':[], 'snr_ZZ':[], 'time_ZZ':[], 'amp_ZZ':[], 'snr_ZR':[],
       'time_ZR':[], 'amp_ZR':[], 'snr_RZ':[], 'time_RZ':[], 'amp_RZ':[], 'snr_RR':[], 'time_RR':[],
       'amp_RR':[], 'source':[], 'receiver':[], 'HV_vertical':[], 'HV_radial':[],
