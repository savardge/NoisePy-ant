function []=main_hautesorne_d250m(period) %period, sigma, LC)
%
%
%
tstart = tic;
...
LC_vec = [1 2 4];
sigma_vec = [0.01 0.1 1]

wave = 'rayleigh'

output_root = '/home/users/s/savardg/scratch/matlab-swant/data-hautesorne/run3_all_g250m/vg-maps-new'
