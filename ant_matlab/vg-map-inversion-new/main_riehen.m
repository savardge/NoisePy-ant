function []=main_riehen(period) %period, sigma, LC)
%
%
%
tstart = tic;
...
sigma_vec = [0.05 0.06 0.07 0.08 0.09]

wave = 'rayleigh';

output_root = '/home/users/s/savardg/scratch/matlab-swant/data-riehen/run6_dcV3_g200m/vg-maps-new'
...
%% Parameters
% STATIONS
% station_file = '/media/genevieve/sandisk4TB/riehen-data/vg-maps/stations_nodes_sed_noisepy.csv';
...
pick_file_csv = ['/home/users/s/savardg/riehen/noisepy-nodes/dispersion-curves/picks_V3_GaussFiltPeriod_rma2_normZ_' wave '_lambda1.5_SNR5.0_margin0.5_multiple3.csv'];
max_std_percent = 20;
min_count = 3;
