% Run checkerboard resolution tests for a range of periods, based on picked data
% 
...
data_kern_path = [datadir '/vg-maps/data_kern_' comp];
...
%% Synthetic model and inversion parameters

% Forward problem
nb_el = 6; %number of linear grid cell in each checkerboard case
v_perturb = 0.30;
v_moy = 2.0;
