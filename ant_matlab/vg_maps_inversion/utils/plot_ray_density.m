function [] = plot_ray_density(G_mat, x_grid, y_grid, dx_grid, dy_grid, x_stat, y_stat, fignum, x_map, y_map, map)
...
cb.LineWidth = 1.5;
ylabel(cb,'# ray paths per cell','fontsize',fontsize)
