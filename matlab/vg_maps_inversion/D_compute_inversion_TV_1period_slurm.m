function [] = D_compute_inversion_TV_1period_slurm(Tc)
...
%% USER INPUTS
doplot = false
datadir = '../../data-aargau/run2_dcV1_g500m'
comp = 'ZZ'
kernel_dir = [datadir '/vg-maps/data_kern_' comp ]
kernel_file = [datadir '/grid/kernel.mat']
map_file =[datadir '/grid/map_matrix_terrain_wFaults.mat'];
% INVERSION PARAMS
...
output_fname = [output_dir '/all_inv_TV_sigma' num2str(sigma) '_LC' num2str(LC) '_' comp '_T' sprintf('%03.1f', Tc) '.mat']
disp(output_fname)
...
%% save
save(output_fname, '-mat', ...
    'm_est1','m_est2','m_est3', ...
    'd','d_post1','d_post2','d_post3', ...
    'm_prior1','d_prior1', ...
    'Tc','x_grid','y_grid','x_stat','y_stat','dx_grid','dy_grid'); 
toc
%% Plot maps
if doplot
